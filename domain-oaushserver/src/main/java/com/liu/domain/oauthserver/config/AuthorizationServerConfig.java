...
import com.liu.domain.oauthserver.exception.CustomOauthException;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private static final String JWT_TOKE_KEY = "mydao@mab#auth$";
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients.inMemory()
                ...
                .scopes(OauthConstants.SCOPES_MAB)
//                .secret("ddd1")
